...
public final class TestContainerLogsUtils {
   ...
   * @param containerId the containerId // TODO mofify this
  ...
  public static void createContainerLogFileInRemoteFS(Configuration conf,
      ...
      String fileName, String user, boolean deleteRemoteLogDir) throws Exception {
  ...
  private static void createContainerLogInLocalDir(Path appLogsDir,
      Map<ContainerId, String> containerToContent, FileSystem fs, String fileName)
      throws IOException{
